...
AD9833_SPI_freq = 20_000_000 #Max SPI Frequency for the AD9833 is 40 MHz
...
def AD9833_write(data_high, data_low):
    """
    ...
    spi = spidev.SpiDev()
    spi.open(bus,device)
    spi.max_speed_hz = AD9833_SPI_freq 
    spi.mode = 2
...
def AD9833_write4(data_l_high, data_l_low, data_h_high, data_h_low):
    """
...
def AD9833_set_freq(f):
    ...
    AD9833_write(0b0010_0000, 0b1000_0000)  # Control reg, Start reset

    FRQREG = int((f) * (2**28) / (master_clk)) 
    ...
    AD9833_write(0b0010_0000, 0b0000_0000) # Control reg, finish reset and configure ic

def AD9833_Init():
    # Initialize AD9833
    AD9833_write(0b0001_0000, 0b0000_0000)
    AD9833_write(0b0100_0000, 0b1111_1111)
